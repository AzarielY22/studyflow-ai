    ...
    <div className="gradient-bg flex min-h-screen items-center justify-center px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Welcome to StudyFlow AI</CardTitle>
          <CardDescription className="text-zinc-400">
            {fromExtension
              ? "Sign in to connect the Chrome extension"
              : "Sign in to start turning content into study materials"}
          </CardDescription>
        </CardHeader>
